        ...
        <section className="historia-ong">
          ...
          <div className="imagem">
            <Swiper
              ...
              <SwiperSlide><img className='imgCarrossel' src="/foto03.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto04.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto05.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto06.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto07.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto08.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto09.jpg" /></SwiperSlide>
              <SwiperSlide><img className='imgCarrossel' src="/foto10.jpg" /></SwiperSlide>
            </Swiper>
        </div>
